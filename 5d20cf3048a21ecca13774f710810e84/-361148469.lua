...
L0_1 = G
L0_1 = L0_1.Class
L1_1 = "BoxingClubResonanceChallengeFilter"
L2_1 = G
...
function L2_1(A0_2)
  ...
  L1_2(L2_2)
  L2_2 = A0_2
  L1_2 = A0_2._refresh_phone_message_reddot
  L1_2(L2_2)
end
L0_1.refresh = L2_1
function L2_1(A0_2)
        ...
        if not L6_2 then
          ...
          if L6_2 == L7_2 then
            ...
            if L6_2 then
              ...
              L8_2 = "BoxingClubResonanceChallengeNew"
...
function L2_1(A0_2)
  ...
  L2_2 = L1_2
  L1_2 = L1_2.IsResonancePhoneMissionFinish
  L1_2 = L1_2(L2_2)
  if not L1_2 then
    L1_2 = G
    ...
    L3_2 = "BoxingClubResonancePhoneMessage"
    L1_2(L2_2, L3_2)
  end
end
L0_1._refresh_phone_message_reddot = L2_1
return L0_1
