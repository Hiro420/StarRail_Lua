...
L0_1 = G
L0_1 = L0_1.Class
L1_1 = "EvolveBuildTutorialPageBinder"
L2_1 = G
L2_1 = L2_1.UIBinder
L0_1 = L0_1(L1_1, L2_1)
L1_1 = require
L2_1 = "Generate.EvolveBuildNovicePageIndex"
L1_1 = L1_1(L2_1)
function L2_1(A0_2)
  local L1_2
  L1_2 = "UI/Quest/EvolveBuild/EvolveBuildNovicePage.prefab"
  return L1_2
end
...
function L2_1(A0_2)
  ...
  if not L1_2 then
    ...
    L2_2 = L2_2.LogTag
    L2_2 = L2_2.UI
    L3_2 = "[EvolveBuild] EvolveBuildTutorialPageBinder: auto_bind Failed."
    L1_2(L2_2, L3_2)
  end
  L2_2 = A0_2
