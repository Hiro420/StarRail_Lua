...
function L1_1(A0_2, A1_2, A2_2, A3_2)
  ...
  A0_2._all_sub_story_data_dict = A2_2
  A0_2._lua_data = A1_2
  A0_2._is_in_rogue = A3_2
  L5_2 = A0_2
  L4_2 = A0_2._setup_nous_value
  L4_2(L5_2)
  L5_2 = A0_2
  L4_2 = A0_2._setup_btn_active_layer
  L4_2(L5_2)
  L5_2 = A0_2
  L4_2 = A0_2._setup_btn_status_layer
  L4_2(L5_2)
  L5_2 = A0_2
  L4_2 = A0_2._setup_title
  L4_2(L5_2)
  L5_2 = A0_2
  L4_2 = A0_2._try_show_reward_can_take_hint
  L4_2(L5_2)
  L5_2 = A0_2
  L4_2 = A0_2._setup_dot_status
  L4_2(L5_2)
  L4_2 = A0_2._binder
  L4_2 = L4_2.reward_panel
  L5_2 = L4_2
...
function L1_1(A0_2, A1_2)
  ...
  L2_2(L3_2, L4_2, L5_2)
  L2_2 = A0_2._binder
  L2_2 = L2_2.nous_panel
  L3_2 = L2_2
  L2_2 = L2_2.set_purple
  L2_2(L3_2)
end
L0_1.set_focused = L1_1
function L1_1(A0_2)
  ...
  L1_2(L2_2, L3_2)
  L1_2 = A0_2._binder
  L1_2 = L1_2.has_reward_bg_root
  L2_2 = L1_2
  L1_2 = L1_2.SafeSetActive
  L3_2 = false
  L1_2(L2_2, L3_2)
end
L0_1.set_reward_inactive = L1_1
function L1_1(A0_2, A1_2)
  local L2_2, L3_2, L4_2
  L2_2 = A0_2._binder
  L2_2 = L2_2.root_btn
...
L0_1.set_root_btn_enabled = L1_1
function L1_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2
  L1_2 = A0_2._binder
  L1_2 = L1_2.nous_panel
  L2_2 = L1_2
  L1_2 = L1_2.set_dark
  L3_2 = true
  L1_2(L2_2, L3_2)
...
L0_1.get_root_canvas_group = L1_1
function L1_1(A0_2)
  local L1_2
  L1_2 = A0_2._binder
  L1_2 = L1_2.in_dot_root
  return L1_2
end
L0_1.get_in_dot_node = L1_1
function L1_1(A0_2)
  local L1_2
  L1_2 = A0_2._binder
  L1_2 = L1_2.out_dot_root
  return L1_2
end
L0_1.get_out_dot_node = L1_1
...
function L1_1(A0_2, A1_2)
  ...
  if L2_2 then
    ...
    if not L2_2 then
      L2_2 = A0_2._binder
      L2_2 = L2_2.first_time_unlock_anim_cmpt
      L3_2 = L2_2
      L2_2 = L2_2.Play
      L2_2(L3_2)
      L2_2 = A0_2._lua_data
      ...
      L2_2 = L2_2.SetRogueNousSubStorySeen
      L3_2 = A0_2._lua_data
      L4_2 = L3_2
      L3_2 = L3_2.get_native
      L3_2 = L3_2(L4_2)
...
L0_1.trigger_effect_by_content_move = L1_1
function L1_1(A0_2, A1_2)
  local L2_2, L3_2, L4_2
  L2_2 = A0_2._binder
  L2_2 = L2_2.root
...
function L1_1(A0_2)
  ...
  if L1_2 ~= "" then
    ...
    if L2_2 then
      ...
      L2_2 = L2_2.Client
      L2_2 = L2_2.RogueNousUtils
      L2_2 = L2_2.IsStoryMeetLayerRequirement
      L3_2 = A0_2._lua_data
      L4_2 = L3_2
      L3_2 = L3_2.get_native
      L3_2, L4_2 = L3_2(L4_2)
...
function L1_1(A0_2)
  ...
  if L1_2 then
    ...
    L1_2 = L1_2.IsStoryMeetLayerRequirement
    L2_2 = A0_2._lua_data
    L3_2 = L2_2
    L2_2 = L2_2.get_native
  ...
  if L1_2 then
    ...
    L1_2 = L1_2.Client
    L1_2 = L1_2.RogueNousUtils
    L1_2 = L1_2.IsCurLayerAccessableSubStory
    L2_2 = A0_2._lua_data
    L3_2 = L2_2
    L2_2 = L2_2.get_native
    L2_2, L3_2, L4_2, L5_2 = L2_2(L3_2)
  ...
  L2_2 = A0_2._lua_data
  L3_2 = L2_2
  L2_2 = L2_2.is_recommended_sub_story
  L2_2 = L2_2(L3_2)
  if L2_2 then
    L2_2 = A0_2._binder
    L2_2 = L2_2.nous_panel
...
function L1_1(A0_2)
  ...
  if L2_2 then
    ...
    L2_2 = L2_2.Client
    L2_2 = L2_2.RogueNousUtils
    L2_2 = L2_2.IsCurLayerAccessableSubStory
    L3_2 = A0_2._lua_data
    L4_2 = L3_2
    L3_2 = L3_2.get_native
...
function L1_1(A0_2)
  ...
  L1_2 = L1_2 == L2_2
  L2_2 = A0_2._binder
  L2_2 = L2_2.has_reward_bg_root
  L3_2 = L2_2
  L2_2 = L2_2.SafeSetActive
  L4_2 = L1_2
  L2_2(L3_2, L4_2)
end
L0_1._try_show_reward_can_take_hint = L1_1
function L1_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2
  L1_2 = A0_2._binder
  L1_2 = L1_2.in_dot_root
  ...
  L3_2 = L3_2.get_native
  L3_2 = L3_2(L4_2)
  L3_2 = L3_2.IsLastLayer
  L3_2 = not L3_2
  L1_2(L2_2, L3_2)
end
L0_1._setup_dot_status = L1_1
function L1_1(A0_2)
  ...
  if not L1_2 then
    ...
    L3_2 = L1_2
    L2_2 = L1_2.init
    L4_2 = "UIText_RogueNous_Story_Untrigger_Title"
    L5_2 = A0_2._lua_data
    L6_2 = L5_2
    L5_2 = L5_2.get_native
    L5_2 = L5_2(L6_2)
    L6_2 = L5_2
    L5_2 = L5_2.GetTriggerConditionText
    L5_2 = L5_2(L6_2)
    L6_2 = false
    L2_2(L3_2, L4_2, L5_2, L6_2)
    L3_2 = L1_2
    L2_2 = L1_2.set_show_nous_value_panel
    L4_2 = A0_2._lua_data
    L5_2 = L4_2
    L4_2 = L4_2.get_native
    L4_2 = L4_2(L5_2)
  ...
  if L1_2 then
    ...
    L1_2 = L1_2.Log
    L2_2 = "\232\167\166\229\143\145\228\186\134"
    L1_2(L2_2)
    return
  end
  L1_2 = A0_2._lua_data
