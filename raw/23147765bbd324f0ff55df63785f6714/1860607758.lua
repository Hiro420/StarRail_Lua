...
L5_1.get_custom_fade_in_anim_name = L6_1
function L6_1(A0_2)
  local L1_2
  L1_2 = A0_2.is_exit
  if L1_2 then
...
L5_1.get_custom_fade_out_anim_name = L6_1
function L6_1(A0_2, A1_2, A2_2)
  local L3_2, L4_2, L5_2
  L3_2 = L2_1
  L4_2 = L3_2
...
L5_1._on_view_active_change = L6_1
function L6_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2
  L1_2 = A0_2._challenge_data
...
L5_1._setup_monster_bar_panel = L6_1
function L6_1(A0_2)
...
L5_1._init_monster_bar_panel = L6_1
function L6_1(A0_2, A1_2)
...
L5_1._setup_auto_skip_tips = L6_1
function L6_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2, L5_2, L6_2, L7_2
  L1_2 = A0_2._challenge_data
  L2_2 = L1_2
...
L5_1._setup_challenge_target = L6_1
function L6_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2, L5_2, L6_2, L7_2
  L1_2 = A0_2._challenge_data
  L2_2 = L1_2
...
L5_1._refresh_challenge_target_with_team_data = L6_1
function L6_1(A0_2)
  local L1_2
end
L5_1._setup_challenge_info = L6_1
function L6_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2, L5_2
  L1_2 = A0_2._challenge_data
  L1_2 = L1_2.IsFinish
...
L5_1._get_cloned_challenge_targets = L6_1
function L6_1(A0_2)
  ...
  if L1_2 == L2_2 then
    ...
    if L1_2 then
      ...
      L2_2 = L1_2
      L1_2 = L1_2.trigger_tutorial_custom_string
      L3_2 = "ChallengeStory.Team.FourMember"
      L1_2(L2_2, L3_2)
    end
  end
  L2_2 = A0_2
...
L5_1._on_selection_changed = L6_1
function L6_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2, L5_2
  L1_2 = G
  L1_2 = L1_2.new
...
L5_1._init_avatar_select_panel = L6_1
function L6_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2, L5_2, L6_2, L7_2
  L1_2 = A0_2._challenge_data
  if L1_2 == nil then
...
L5_1._is_all_lineup_not_empty = L6_1
function L6_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2, L5_2
  L1_2 = 1
  L2_2 = A0_2._challenge_data
...
L5_1._is_all_buff_slot_filled = L6_1
function L6_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2
  L1_2 = {}
...
L5_1._init_lineup_bar_panel = L6_1
function L6_1(A0_2)
  local L1_2, L2_2, L3_2
  L2_2 = A0_2
...
L5_1._on_edit_click_second = L6_1
function L6_1(A0_2, A1_2, A2_2)
  local L3_2, L4_2, L5_2
  L3_2 = A0_2._avatar_selection
  L4_2 = L3_2
...
L5_1._on_slot_click_second = L6_1
function L6_1(A0_2, A1_2)
...
L5_1._create_edit_team_data = L6_1
function L6_1(A0_2, A1_2)
  local L2_2, L3_2, L4_2, L5_2, L6_2, L7_2, L8_2, L9_2, L10_2
  L2_2 = pairs
  L3_2 = A0_2._lineup_bar_panels
...
L5_1._get_avatars_in_all_team = L6_1
function L6_1(A0_2, A1_2)
  local L2_2, L3_2, L4_2, L5_2, L6_2, L7_2
  L2_2 = A0_2.team_buff
  L2_2 = L2_2[A1_2]
...
L5_1._refresh_start_status = L6_1
function L6_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2, L5_2
  L2_2 = A0_2
...
L5_1._on_btn_avatar_detail = L6_1
function L6_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2, L5_2, L6_2, L7_2, L8_2, L9_2, L10_2, L11_2
  L1_2 = {}
  L2_2 = pairs
...
function L6_1(A0_2)
  ...
  L2_2[1] = L1_2
  L3_2 = A0_2
  L2_2 = A0_2._on_selection_changed
  L2_2(L3_2)
end
L5_1._on_btn_switch_team = L6_1
function L6_1(A0_2)
  local L1_2, L2_2, L3_2
  L2_2 = A0_2
  L1_2 = A0_2._is_all_team_empty
...
function L6_1(A0_2)
  ...
  L4_2(L5_2, L6_2)
  L4_2 = A0_2._binder
  L4_2 = L4_2.btn_switch_team
  L5_2 = L4_2
  L4_2 = L4_2.SafeSetActive
  L6_2 = not L1_2 and L6_2
  L4_2(L5_2, L6_2)
  L4_2 = A0_2._binder
  L4_2 = L4_2.btn_clear_team
  L5_2 = L4_2
  L4_2 = L4_2.SafeSetActive
  L6_2 = not L1_2
  L4_2(L5_2, L6_2)
end
L5_1._refresh_gamepad_btns = L6_1
function L6_1(A0_2)
  local L1_2, L2_2
  L1_2 = A0_2._cur_lineup_bar_panel
  L2_2 = A0_2._lineup_bar_panels
...
L5_1._on_gamepad_switch_team = L6_1
function L6_1(A0_2)
  local L1_2, L2_2, L3_2
  L1_2 = A0_2._cur_lineup_bar_panel
  L2_2 = A0_2._lineup_bar_panels
...
L5_1._on_gamepad_show_tip = L6_1
return L5_1
