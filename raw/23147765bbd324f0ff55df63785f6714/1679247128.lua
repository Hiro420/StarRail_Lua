...
L0_1.reg_slider_value_change_call_back = L2_1
...
L0_1.setup_slider_value = L2_1
function L2_1(A0_2, A1_2)
  A0_2._in_control_press_enable = A1_2
end
L0_1.setup_in_control_press_enable = L2_1
function L2_1(A0_2)
...
L0_1.on_map_scale_change_without_notify = L2_1
function L2_1(A0_2, A1_2)
  local L2_2, L3_2, L4_2
  L2_2 = A0_2._binder
  L2_2 = L2_2.progress_slider
...
L0_1.setup_slider_value_without_callback = L2_1
function L2_1(A0_2, A1_2, A2_2)
  ...
  L3_2 = L1_1.frameCount
  L4_2 = CS
  L4_2 = L4_2.InControl
  L4_2 = L4_2.InputControlType
  L4_2 = L4_2.LeftTrigger
  L4_2 = #L4_2
  if A1_2 == L4_2 then
    L4_2 = A0_2._frame_index
    if L3_2 == L4_2 then
      return
    end
    A0_2._frame_index = L3_2
    L5_2 = A0_2
    L4_2 = A0_2._on_left_trigger_press
    L6_2 = A2_2
    L4_2(L5_2, L6_2)
  else
    L4_2 = CS
    ...
    if A1_2 == L4_2 then
      ...
      A0_2._frame_index = L3_2
      L5_2 = A0_2
      L4_2 = A0_2._on_right_trigger_press
      L6_2 = A2_2
      L4_2(L5_2, L6_2)
    end
  end
...
L0_1._on_left_trigger_press = L2_1
function L2_1(A0_2, A1_2)
  local L2_2, L3_2, L4_2
  L3_2 = A0_2
  L2_2 = A0_2.setup_slider_value
...
L0_1._on_right_trigger_press = L2_1
function L2_1(A0_2)
...
L0_1._on_long_btn_plus_repeat = L2_1
function L2_1(A0_2)
  local L1_2, L2_2, L3_2
  L1_2 = A0_2._binder
  L1_2 = L1_2.progress_slider
...
L0_1._on_long_btn_minus_repeat = L2_1
function L2_1(A0_2, A1_2)
  local L2_2, L3_2, L4_2
  L2_2 = A0_2._binder
  L2_2 = L2_2.progress_slider
...
L0_1._plus_progress_slider_value = L2_1
function L2_1(A0_2, A1_2)
  local L2_2, L3_2, L4_2
  L2_2 = A0_2._binder
  L2_2 = L2_2.progress_slider
...
L0_1._minus_progress_slider_value = L2_1
return L0_1
