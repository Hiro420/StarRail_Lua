...
function L7_1(A0_2)
  local L1_2, L2_2
  L2_2 = A0_2
  L1_2 = A0_2._is_can_transfer
  L1_2 = L1_2(L2_2)
  if L1_2 then
    L2_2 = A0_2
    L1_2 = A0_2._on_mapping_info_btn_transfer_click
    L1_2(L2_2)
  else
    L2_2 = A0_2
    L1_2 = A0_2._transfer_nearest_teleport
    L1_2(L2_2)
  end
end
...
function L7_1(A0_2)
  ...
  L3_2 = G
  L3_2 = L3_2.MapUtil
  L3_2 = L3_2.try_get_nearest_teleport_id
  L4_2 = L1_2
  L5_2 = A0_2._target_position
  L6_2 = A0_2._cur_map_layer_count
  L7_2 = A0_2._map_container_panel
  L8_2 = L2_2
  L3_2 = L3_2(L4_2, L5_2, L6_2, L7_2, L8_2)
  L5_2 = A0_2
  L4_2 = A0_2._transfer_with_story_line_check
...
function L7_1(A0_2)
  ...
  if L1_2 then
    ...
    if 0 < L1_2 then
      ...
      L4_2 = "UIText_MappingInfo_Track_Toast_NoTeleportNearby"
      L2_2(L3_2, L4_2)
    end
  else
    L1_2 = G
