...
L0_1(L1_1)
L0_1 = require
L1_1 = "Ui.Common.FilterSort.FilterItemPanel"
L0_1(L1_1)
L0_1 = require
L1_1 = "Ui.Common.FilterSort.FilterItemPanelBinder"
L0_1(L1_1)
L0_1 = G
L0_1 = L0_1.Class
L1_1 = "RelicFilterMultiSelectPanel"
L2_1 = G
L2_1 = L2_1.BasePanel
L0_1 = L0_1(L1_1, L2_1)
function L1_1(A0_2)
...
function L1_1(A0_2, A1_2, A2_2, A3_2)
  ...
  L4_2 = L4_2.save
  L4_2(L5_2)
  A0_2._available_filter_types = A2_2
  A0_2._locked_filter_types = A3_2
  L4_2 = A3_2 ~= nil
  A0_2._lock_select = L4_2
  L5_2 = A0_2
  L4_2 = A0_2._refresh
  L4_2(L5_2)
end
...
function L1_1(A0_2)
  ...
  L2_2 = A0_2
  L1_2 = A0_2._refresh_available_filter_data
  L1_2(L2_2)
  L1_2 = A0_2._binder
  L1_2 = L1_2.filter_list
  L2_2 = L1_2
...
function L1_1(A0_2)
  ...
  L1_2 = A0_2._lock_select
  if L1_2 then
    L1_2 = pairs
    L2_2 = A0_2._filter
    L3_2 = L2_2
    L2_2 = L2_2.get_filter_data
    ...
    for L4_2, L5_2 in L1_2, L2_2, L3_2 do
      ...
      L7_2 = A0_2._locked_filter_types
      L8_2 = L5_2.FilterType
      L6_2 = L6_2(L7_2, L8_2)
      if L6_2 ~= nil then
        L6_2 = table
        L6_2 = L6_2.insert
        L7_2 = A0_2._active_filter_datas
        L8_2 = L5_2
        L6_2(L7_2, L8_2)
      end
    end
  ...
  L1_2 = A0_2._available_filter_types
  if L1_2 ~= nil then
    L1_2 = pairs
    L2_2 = A0_2._filter
    L3_2 = L2_2
    ...
    for L4_2, L5_2 in L1_2, L2_2, L3_2 do
      ...
      L6_2 = L6_2.Utils
      L6_2 = L6_2.index_of_item
      L7_2 = A0_2._available_filter_types
      L8_2 = L5_2.FilterType
      L6_2 = L6_2(L7_2, L8_2)
      if L6_2 ~= nil then
        L6_2 = table
...
L0_1._refresh_available_filter_data = L1_1
function L1_1(A0_2, A1_2, A2_2)
  ...
  L6_2(L7_2, L8_2, L9_2)
  L7_2 = L4_2
  L6_2 = L4_2.set_interactable
  L8_2 = A0_2._lock_select
  L8_2 = not L8_2
  L6_2(L7_2, L8_2)
  return L3_2
end
...
function L1_1(A0_2, A1_2, A2_2)
  ...
  L3_2 = A0_2._filter
  L4_2 = L3_2
  L3_2 = L3_2.set_filter_state_by_type
  L5_2 = A1_2
  L6_2 = false
  L3_2(L4_2, L5_2, L6_2)
  L4_2 = A0_2
...
function L1_1(A0_2)
  ...
  L2_2 = A0_2._filter
  L3_2 = L2_2
  L2_2 = L2_2.get_max_selection
  L2_2 = L2_2(L3_2)
  if L2_2 ~= 0 then
    L3_2 = L1_2
    L2_2 = L1_2.set_tips
    L4_2 = "UIText_Relic_Screen_SubProperty_AddNumberLimitTips"
    L2_2(L3_2, L4_2)
  end
end
