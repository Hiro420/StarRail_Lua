...
function L2_1(A0_2, A1_2, A2_2, A3_2, A4_2)
  ...
  for L8_2 = L5_2, L6_2, L7_2 do
    L10_2 = A0_2
    L9_2 = A0_2._get_or_create_avatar_panel
...
function L2_1(A0_2, A1_2, A2_2, A3_2, A4_2)
  ...
  L7_2 = A2_2
  L5_2(L6_2, L7_2)
  L5_2 = A0_2._panels_avatar_team
  if L5_2 == nil then
    L5_2 = {}
    A0_2._panels_avatar_team = L5_2
  end
  L5_2 = A3_2 ~= nil and A4_2 ~= nil
  if L5_2 then
    L6_2 = {}
    if L6_2 then
      goto lbl_24
  ...
  L6_2 = nil
  ::lbl_24::
  L7_2 = A0_2._team_avatar_data_table
  L7_2 = #L7_2
  L8_2 = 1
  L9_2 = L7_2
  L10_2 = 1
  for L11_2 = L8_2, L9_2, L10_2 do
    L13_2 = A0_2
    L12_2 = A0_2._get_or_create_avatar_panel
    L14_2 = A0_2._panels_avatar_team
    L15_2 = L11_2
    L12_2 = L12_2(L13_2, L14_2, L15_2)
    L13_2 = A0_2._team_avatar_data_table
    L13_2 = L13_2[L11_2]
    L15_2 = A0_2
    L14_2 = A0_2._get_avatar_team_slot
    L16_2 = L13_2
    L14_2 = L14_2(L15_2, L16_2)
    L15_2 = L14_2 ~= nil
    L17_2 = L12_2
    L16_2 = L12_2.set_icon
    L18_2 = L13_2
    L16_2(L17_2, L18_2)
    L17_2 = L12_2
    L16_2 = L12_2.set_number_mark
    L18_2 = L15_2
    if L15_2 then
      L19_2 = "0"
      L20_2 = tostring
    ...
    L17_2 = L12_2
    L16_2 = L12_2.set_btn_interactable
    L18_2 = L5_2
    L16_2(L17_2, L18_2)
    L17_2 = L12_2
    L16_2 = L12_2.set_trial_mark
    L18_2 = false
    L19_2 = L13_2
    L16_2(L17_2, L18_2, L19_2)
    if L5_2 then
      L17_2 = L12_2
      L16_2 = L12_2.register_callback
      L18_2 = A3_2
      L19_2 = A4_2
      L20_2 = L13_2
...
function L2_1(A0_2, A1_2, A2_2)
  ...
  L3_2 = {}
  A0_2._avatar_order_table = L3_2
  L3_2 = 3
  L4_2 = ipairs
  L5_2 = A2_2
  L4_2, L5_2, L6_2 = L4_2(L5_2)
  for L7_2, L8_2 in L4_2, L5_2, L6_2 do
    L9_2 = A0_2._avatar_order_table
    L10_2 = L8_2.ID
    L11_2 = L7_2 + L3_2
    L9_2[L10_2] = L11_2
  end
  ...
  for L8_2 = L5_2, L6_2, L7_2 do
    ...
    if L9_2 then
      L10_2 = A0_2._avatar_order_table
      L11_2 = L9_2.AvatarID
      L10_2[L11_2] = L8_2
    end
  end
...
L0_1._get_or_create_avatar_panel = L2_1
function L2_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2
  L2_2 = A0_2
  L1_2 = A0_2.instantiate_object
  L3_2 = A0_2._binder
  L3_2 = L3_2.loader_avatar
  L3_2 = L3_2.MultiPrefabList
  L3_2 = L3_2[0]
  L4_2 = A0_2._binder
  L4_2 = L4_2.loader_avatar
  L4_2 = L4_2.transform
  return L1_2(L2_2, L3_2, L4_2)
end
L0_1._load_avatar_node = L2_1
function L2_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2
  L2_2 = A0_2
  L1_2 = A0_2.instantiate_object
