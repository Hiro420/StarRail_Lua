...
function L5_1(A0_2, A1_2)
  ...
  L2_2(L3_2, L4_2)
  L2_2 = A0_2._binder
  L2_2 = L2_2.node_delete
  L3_2 = L2_2
  L2_2 = L2_2.SafeSetActive
  L4_2 = A1_2
  L2_2(L3_2, L4_2)
end
L0_1.setup_delete_mode = L5_1
function L5_1(A0_2, A1_2)
  local L2_2, L3_2, L4_2
  L2_2 = A0_2._binder
...
function L5_1(A0_2)
  ...
  L1_2(L2_2)
  L2_2 = A0_2
  L1_2 = A0_2._refresh_record_info
  L1_2(L2_2)
end
L0_1._refresh = L5_1
function L5_1(A0_2)
...
function L5_1(A0_2)
  ...
  if L2_2 then
    ...
    L3_2 = L3_2.panel_online_status
    L4_2 = L3_2
    L3_2 = L3_2.set_playing_state
    L5_2 = L1_1.get_playing_state
    L6_2 = A0_2._data
    L6_2 = L6_2.UID
    L5_2, L6_2 = L5_2(L6_2)
    L3_2(L4_2, L5_2, L6_2)
...
L0_1._refresh_record_info = L5_1
function L5_1(A0_2, A1_2, A2_2)
...
function L5_1(A0_2)
  ...
  L1_2 = L1_1.show_friend_detail_info
  L2_2 = A0_2._data
  L2_2 = L2_2.UID
  L1_2(L2_2)
end
...
function L5_1(A0_2)
  ...
  L1_2 = G
  L1_2 = L1_2.FriendUtils
  L1_2 = L1_2.do_delete_friend
  L2_2 = A0_2._data
  L2_2 = L2_2.UID
  L3_2 = 2
  L1_2(L2_2, L3_2)
end
L0_1._on_btn_delete = L5_1
function L5_1(A0_2)
  local L1_2, L2_2
  L1_2 = G
  L1_2 = L1_2.Utils
