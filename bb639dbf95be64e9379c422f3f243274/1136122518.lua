...
L0_1 = G
L0_1 = L0_1.Class
L1_1 = "ActivityTelevisionQuestPage"
L2_1 = G
L2_1 = L2_1.UIController
L0_1 = L0_1(L1_1, L2_1)
L1_1 = require
L2_1 = "Ui.ActivityTelevision.Reward.ActivityTelevisionQuestPageBinder"
L1_1(L2_1)
L1_1 = require
L2_1 = "Ui.ActivityTelevision.Reward.ActivityTelevisionQuestLevelPanel"
L1_1(L2_1)
L1_1 = require
L2_1 = "Ui.ActivityTelevision.Reward.ActivityTelevisionQuestLevelPanelBinder"
L1_1(L2_1)
L1_1 = require
L2_1 = "Ui.ActivityTelevision.Reward.ActivityTelevisionQuestRowPanel"
L1_1(L2_1)
L1_1 = require
L2_1 = "Ui.ActivityTelevision.Reward.ActivityTelevisionQuestRowPanelBinder"
L1_1(L2_1)
L1_1 = require
L2_1 = "Ui.ActivityTelevision.Reward.ActivityTelevisionTreasureRowPanel"
L1_1(L2_1)
L1_1 = require
L2_1 = "Ui.ActivityTelevision.Reward.ActivityTelevisionTreasureRowPanelBinder"
L1_1(L2_1)
L1_1 = CS
L1_1 = L1_1.RPG
L1_1 = L1_1.Client
...
function L3_1(A0_2)
  ...
  L3_2 = G
  L3_2 = L3_2.ActivityTelevisionQuestPageBinder
  L1_2 = L1_2(L2_2, L3_2)
  A0_2._binder = L1_2
...
function L3_1(A0_2)
  ...
  L3_2 = G
  L3_2 = L3_2.ActivityTelevisionTreasureRowPanel
  L4_2 = G
  L4_2 = L4_2.ActivityTelevisionTreasureRowPanelBinder
...
function L3_1(A0_2)
  local L1_2, L2_2, L3_2
  L1_2 = L2_1.TreasureQuestGroupID
  L2_2 = CS
  L2_2 = L2_2.RPG
  L2_2 = L2_2.GameCore
  L2_2 = L2_2.ActivityTelevisionQuestExcelTable
  L2_2 = L2_2.GetData
  L3_2 = L1_2
  L2_2 = L2_2(L3_2)
  A0_2.treasure_quest_row = L2_2
  L2_2 = A0_2.treasure_quest_row
  L2_2 = L2_2.QuestIDList
  L2_2 = L2_2[0]
  A0_2.treasure_quest_id = L2_2
end
L0_1.init_treasure_quest_id = L3_1
function L3_1(A0_2)
  local L1_2
end
...
function L3_1(A0_2)
  ...
  L1_2 = A0_2.treasure_panel
  L2_2 = L1_2
  L1_2 = L1_2.setup_name
  L3_2 = A0_2.treasure_quest_row
  L3_2 = L3_2.TabName
  L1_2(L2_2, L3_2)
  L1_2 = A0_2.treasure_panel
  L2_2 = L1_2
...
function L3_1(A0_2, A1_2)
  ...
  if A1_2 == L2_2 then
    ...
    if L2_2 then
      L3_2 = A0_2
      L2_2 = A0_2.get_treasure_quest_object
      L2_2 = L2_2(L3_2)
      L4_2 = A0_2
...
function L3_1(A0_2)
  ...
  L3_2 = A0_2.current_select_idx_from_zero
  L1_2 = L1_2(L2_2, L3_2)
  if L1_2 ~= nil then
...
L0_1.get_treasure_quest_object = L3_1
function L3_1(A0_2)
  local L1_2, L2_2, L3_2
  L2_2 = A0_2
...
function L3_1(A0_2, A1_2, A2_2)
  ...
  if L5_2 == nil then
    ...
    L8_2 = G
    L8_2 = L8_2.ActivityTelevisionQuestLevelPanel
    L9_2 = G
    L9_2 = L9_2.ActivityTelevisionQuestLevelPanelBinder
...
L0_1._on_level_button = L3_1
function L3_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2, L5_2, L6_2
  L1_2 = A0_2.current_data
  L1_2 = L1_2.ScheduleData
  if L1_2 then
    L1_2 = A0_2.current_data
    L1_2 = L1_2.ScheduleData
  ...
  A0_2._cur_level_lock = L1_2
  L1_2 = A0_2._binder
  L1_2 = L1_2.node_unlock_timer
  L2_2 = L1_2
  L1_2 = L1_2.SafeSetActive
  L3_2 = A0_2._cur_level_lock
  L1_2(L2_2, L3_2)
  L1_2 = A0_2._cur_level_lock
  if L1_2 then
    L1_2 = A0_2._binder
    L1_2 = L1_2.remain_timer_level
    L2_2 = L1_2
    L1_2 = L1_2.SetTargetTimeByTimeStamp
    L3_2 = A0_2.current_data
    L3_2 = L3_2.ScheduleData
    L3_2 = L3_2.BeginTimeStamp
    L4_2 = A0_2.refresh_quest
    L5_2 = A0_2
    L6_2 = 2
    L1_2(L2_2, L3_2, L4_2, L5_2, L6_2)
  end
end
L0_1._setup_unlock_time_node = L3_1
function L3_1(A0_2)
...
L0_1.set_level_checked_by_index = L3_1
function L3_1(A0_2, A1_2)
  local L2_2
...
function L3_1(A0_2, A1_2, A2_2)
  ...
  if L5_2 == nil then
    ...
    L6_2 = A0_2.create_panel
    L8_2 = G
    L8_2 = L8_2.ActivityTelevisionQuestRowPanel
    L9_2 = G
    L9_2 = L9_2.ActivityTelevisionQuestRowPanelBinder
    L6_2 = L6_2(L7_2, L8_2, L9_2)
    L5_2 = L6_2
    L7_2 = L5_2
    L6_2 = L5_2.bind
...
L0_1._get_first_unfinished_level_index = L3_1
function L3_1(A0_2)
  local L1_2, L2_2
  L1_2 = A0_2.treasure_panel
  L2_2 = L1_2
...
L0_1.refresh_treasure_panel = L3_1
return L0_1
