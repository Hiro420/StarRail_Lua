...
L0_1(L1_1)
L0_1 = require
L1_1 = "Ui.Activity.ActivityPunkLord.Maze.PunkLordMazeInfoPanel"
L0_1(L1_1)
L0_1 = require
L1_1 = "Ui.Activity.ActivityPunkLord.Maze.PunkLordMazeInfoPanelBinder"
L0_1(L1_1)
L0_1 = require
L1_1 = "Ui.Activity.ActivityPunkLord.Maze.PunkLordMazeTargetPanel"
L0_1(L1_1)
L0_1 = require
L1_1 = "Ui.Activity.ActivityPunkLord.Maze.PunkLordMazeTargetPanelBinder"
L0_1(L1_1)
L0_1 = require
...
function L1_1(A0_2)
  ...
  L1_2(L2_2, L3_2, L4_2)
  L2_2 = A0_2
  L1_2 = A0_2._add_punklord_handler
  L1_2(L2_2)
end
...
function L1_1(A0_2)
  ...
  L1_2(L2_2)
  L2_2 = A0_2
  L1_2 = A0_2._setup_view_punklord
  L1_2(L2_2)
end
...
function L1_1(A0_2)
  ...
  L3_2 = A0_2._binder
  L3_2 = L3_2.prefab_load_punklord
  L3_2 = L3_2.Prefab
  L4_2 = A0_2._binder
  L4_2 = L4_2.prefab_load_punklord
  L4_2 = L4_2.transform
  L1_2 = L1_2(L2_2, L3_2, L4_2)
  L3_2 = A0_2
  L2_2 = A0_2.create_panel
  L4_2 = G
  L4_2 = L4_2.PunkLordMazeInfoPanel
  L5_2 = G
  L5_2 = L5_2.PunkLordMazeInfoPanelBinder
  L2_2 = L2_2(L3_2, L4_2, L5_2)
  A0_2._punklord_maze_info_panel = L2_2
  L2_2 = A0_2._punklord_maze_info_panel
  L3_2 = L2_2
  L2_2 = L2_2.bind
  L4_2 = L1_2
  L2_2(L3_2, L4_2)
  ...
  L2_2 = A0_2.create_panel
  L4_2 = G
  L4_2 = L4_2.PunkLordMazeTargetPanel
  L5_2 = G
  L5_2 = L5_2.PunkLordMazeTargetPanelBinder
  L2_2 = L2_2(L3_2, L4_2, L5_2)
...
function L1_1(A0_2)
  ...
  L3_2 = L3_2.CS
  L3_2 = L3_2.NotifyType
  L3_2 = L3_2.PunkLordNotifyAttackInfo
  L4_2 = L0_1._on_notify_attack_info
  L1_2(L2_2, L3_2, L4_2)
  L2_2 = A0_2
  L1_2 = A0_2._add_notify_handler
  L3_2 = G
  L3_2 = L3_2.CS
  L3_2 = L3_2.NotifyType
  L3_2 = L3_2.PunkLordNotifyPlayerEnterRaid
  L4_2 = L0_1._on_notify_player_enter
  L1_2(L2_2, L3_2, L4_2)
  L2_2 = A0_2
  L1_2 = A0_2._add_notify_handler
  L3_2 = G
  L3_2 = L3_2.CS
  L3_2 = L3_2.NotifyType
  L3_2 = L3_2.PunkLordInstanceSettled
  L4_2 = A0_2._on_punklord_settled
  L1_2(L2_2, L3_2, L4_2)
  L2_2 = A0_2
  L1_2 = A0_2._add_notify_handler
  L3_2 = G
  L3_2 = L3_2.CS
  L3_2 = L3_2.NotifyType
  L3_2 = L3_2.PunkLordInstanceSettledFinish
  L4_2 = A0_2._on_punklord_settled_finish
  L1_2(L2_2, L3_2, L4_2)
end
L0_1._add_punklord_handler = L1_1
function L1_1(A0_2)
  local L1_2, L2_2
  L1_2 = A0_2._punklord_maze_info_panel
  L2_2 = L1_2
  L1_2 = L1_2.setup_view
  L1_2(L2_2)
  L1_2 = A0_2._maze_target_panel
  L2_2 = L1_2
  L1_2 = L1_2.fresh_monster_hp
  L1_2(L2_2)
end
L0_1._setup_view_punklord = L1_1
function L1_1(A0_2, A1_2)
  local L2_2, L3_2, L4_2
  L2_2 = A0_2._maze_target_panel
  L3_2 = L2_2
  L2_2 = L2_2.fresh_monster_hp
  L2_2(L3_2)
  L2_2 = A0_2._punklord_maze_info_panel
  L3_2 = L2_2
  L2_2 = L2_2.show_attack_info
  L4_2 = A1_2
  L2_2(L3_2, L4_2)
end
L0_1._on_notify_attack_info = L1_1
function L1_1(A0_2)
  local L1_2, L2_2
  L1_2 = A0_2._punklord_maze_info_panel
  L2_2 = L1_2
...
L0_1._on_notify_player_enter = L1_1
function L1_1(A0_2)
  local L1_2, L2_2
  L1_2 = G
  L1_2 = L1_2.UIManager
  L1_2 = L1_2.load_and_async_show
  L2_2 = "Ui.Activity.ActivityPunkLord.Result.PunkLordScoreDialog"
  L1_2(L2_2)
end
L0_1._on_punklord_settled = L1_1
function L1_1(A0_2)
  local L1_2, L2_2
  L1_2 = G
  L1_2 = L1_2.UIManager
  L1_2 = L1_2.load_and_async_show
  L2_2 = "Ui.Activity.ActivityPunkLord.Result.PunkLordResultDialog"
  L1_2(L2_2)
end
L0_1._on_punklord_settled_finish = L1_1
return L0_1
