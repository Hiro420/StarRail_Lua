...
L0_1(L1_1)
L0_1 = require
L1_1 = "Ui.Activity.ActivityPanel.SingleQuestActivityPanelBinder"
L0_1(L1_1)
L0_1 = CS
L0_1 = L0_1.RPG
L0_1 = L0_1.Client
...
L2_1 = L2_1.GetData
L3_1 = "Abyss_UnlockMissionLevel"
L2_1 = L2_1(L3_1)
L2_1 = L2_1.Value
L2_1 = L2_1.IntValue
L3_1 = "UIText_Abyss_Activity_OpenLevel"
L4_1 = CS
L4_1 = L4_1.RPG
L4_1 = L4_1.GameCore
L4_1 = L4_1.ConstValueClientExcelTable
L4_1 = L4_1.GetData
L5_1 = "Abyss_UnlockMessageGroupID"
L4_1 = L4_1(L5_1)
L4_1 = L4_1.Value
L4_1 = L4_1.IntValue
L5_1 = CS
...
L5_1 = L5_1.GetData
L6_1 = "Abyss_UnlockMissionList"
L5_1 = L5_1(L6_1)
L5_1 = L5_1.Value
L5_1 = L5_1.ArrayValue
L6_1 = G
L6_1 = L6_1.Class
L7_1 = "SingleQuestActivityPanel"
L8_1 = G
L8_1 = L8_1.TabItem
L6_1 = L6_1(L7_1, L8_1)
...
function L7_1(A0_2)
  ...
  L5_2 = L6_1._on_quest_get_reward
  L2_2(L3_2, L4_2, L5_2)
  L3_2 = A0_2
  L2_2 = A0_2._bind_btn_callback
  L4_2 = A0_2._binder
...
function L7_1(A0_2)
  ...
  for L4_2 = L1_2, L2_2, L3_2 do
    L5_2 = L5_1[L4_2]
    L5_2 = L5_2.UintValue
    L6_2 = A0_2._cs_unlock_main_mission_id_list
    L7_2 = L6_2
    L6_2 = L6_2.Add
    L8_2 = L5_2
    L6_2(L7_2, L8_2)
...
L6_1._init_cs_unlock_main_mission_list = L7_1
function L7_1(A0_2)
  local L1_2
  L1_2 = A0_2._binder
  L1_2 = L1_2.btn_unavailable
  L1_2.interactable = false
  L1_2 = A0_2._binder
  L1_2 = L1_2.btn_got
  L1_2.interactable = false
end
L6_1._init_reward_btn = L7_1
function L7_1(A0_2)
  local L1_2, L2_2
  L2_2 = A0_2
  L1_2 = A0_2._setup_bg
...
L6_1._refresh_quest_state = L7_1
function L7_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2, L5_2, L6_2, L7_2
  L1_2 = pairs
...
L6_1._on_desc_btn_clicked = L7_1
function L7_1(A0_2)
  ...
  L3_2(L4_2, L5_2)
  L3_2 = A0_2._binder
  L3_2 = L3_2.btn_unavailable
  L4_2 = L3_2
  L3_2 = L3_2.SafeSetActive
  L5_2 = not L1_2 and L5_2
  L3_2(L4_2, L5_2)
end
L6_1._setup_reward_btn = L7_1
function L7_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2, L5_2, L6_2, L7_2, L8_2
  L2_2 = A0_2
  L1_2 = A0_2._is_quest_finish
...
L6_1._on_btn_get = L7_1
function L7_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2
  L2_2 = A0_2
  L1_2 = A0_2._check_player_level
  L3_2 = L2_1
  L1_2 = L1_2(L2_2, L3_2)
  if not L1_2 then
    L1_2 = G
...
function L7_1(A0_2, A1_2)
  ...
  L3_2 = L2_2
  L2_2 = L2_2.TryGetMessageGroup
  L4_2 = A1_2
  L2_2 = L2_2(L3_2, L4_2)
  L3_2 = L2_2 == nil
  return L3_2
end
L6_1._check_read_message = L7_1
function L7_1(A0_2, A1_2)
...
L6_1._on_quest_get_reward = L8_1
return L6_1
