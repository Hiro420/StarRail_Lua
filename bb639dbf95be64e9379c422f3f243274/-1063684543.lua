...
L0_1 = require
L1_1 = "Ui.ActivityMonopoly.MiniGamePage.ActivityMonopolyMiniGameBingoBPageBinder"
L0_1(L1_1)
L0_1 = CS
L0_1 = L0_1.RPG
L0_1 = L0_1.Client
...
L1_1 = "MonopolyCookieDiagramBombHint"
L2_1 = {}
L2_1.Start = 1
L2_1.Progress = 2
L2_1.Finish = 3
L3_1 = G
L3_1 = L3_1.Class
L4_1 = "ActivityMonopolyMiniGameBingoBPage"
L5_1 = G
...
function L4_1(A0_2)
  ...
  L3_2 = G
  L3_2 = L3_2.ActivityMonopolyMiniGameBingoBPageBinder
  L1_2 = L1_2(L2_2, L3_2)
  A0_2._binder = L1_2
  L1_2 = G
...
function L4_1(A0_2)
  ...
  if L1_2 then
    ...
    if L1_2 then
      ...
      A0_2._state = L1_2
      L2_2 = A0_2
      L1_2 = A0_2._init_start_game_state
      L1_2(L2_2)
    else
      L1_2 = L2_1.Start
      A0_2._state = L1_2
...
function L4_1(A0_2)
  ...
  L3_2 = L3_2.CS
  L3_2 = L3_2.NotifyType
  L3_2 = L3_2.UIMonopolyGameBingoBoomUpdate
  L4_2 = A0_2._on_boom_update
  L1_2(L2_2, L3_2, L4_2)
end
...
function L4_1(A0_2)
  ...
  L6_2 = A0_2._display_resource_id
  L7_2 = A0_2._cur_flip_cookie_index
  L6_2 = L6_2[L7_2]
  L4_2 = L4_2(L5_2, L6_2)
  L3_2 = L3_2 + L4_2
  A0_2._result = L3_2
...
function L4_1(A0_2)
  local L1_2, L2_2, L3_2
  L2_2 = A0_2
  L1_2 = A0_2._update_boom_pos
  L1_2(L2_2)
  L1_2 = A0_2._binder
  L1_2 = L1_2.panel_bingo
  L2_2 = L1_2
  L1_2 = L1_2.update_boom_cookie
  L3_2 = A0_2._is_pos_boom
  L1_2(L2_2, L3_2)
end
L3_1._on_boom_update = L4_1
function L4_1(A0_2)
...
L3_1._init_start_game_state = L4_1
function L4_1(A0_2)
...
function L4_1(A0_2)
  ...
  A0_2._is_pos_boom = nil
  do return end
  ::lbl_12::
  L1_2 = {}
  A0_2._is_pos_boom = L1_2
  L1_2 = 1
  L2_2 = A0_2._display_resource_id
  L2_2 = #L2_2
  L3_2 = 1
  for L4_2 = L1_2, L2_2, L3_2 do
    L5_2 = A0_2._bingo_data
    L5_2 = L5_2.BoomPosList
    L6_2 = L5_2
    L5_2 = L5_2.Contains
    L7_2 = L4_2
    L5_2 = L5_2(L6_2, L7_2)
    L6_2 = table
    L6_2 = L6_2.insert
    L7_2 = A0_2._is_pos_boom
    L8_2 = L5_2
    L6_2(L7_2, L8_2)
  end
end
L3_1._update_boom_pos = L4_1
function L4_1(A0_2)
