...
function L3_1(A0_2)
  ...
  if L3_2 then
    ...
    L4_2 = L4_2.Link
    L3_2.show_type = L4_2
    L4_2 = AccountSettingType
    L4_2 = L4_2.UserCenter
    L3_2.setting_type = L4_2
    L3_2.title_text_id = "UIText_Setting_Event_AccountCenter"
    if L1_2 == false then
      L3_2.setting_title_text_id = "UIText_Setting_Title_Account"
      L1_2 = true
    end
    L4_2 = table
    L4_2 = L4_2.insert
  ...
  if L3_2 then
    ...
    L3_2 = data
    L4_2 = AccountSettingType
    L4_2 = L4_2.UserAgreement
    L3_2.setting_type = L4_2
    L3_2 = data
    L3_2.title_text_id = "UIText_Setting_Event_UserAgreement"
    if L1_2 == false then
      L3_2 = data
      L3_2.setting_title_text_id = "UIText_Setting_Title_Account"
      L1_2 = true
  ...
  if L3_2 then
    ...
    if L3_2 then
      ...
      L4_2 = L3_2
      L3_2 = L3_2.OAKPAFBNBAF
      L5_2 = "PrivacyInGameUrl"
      L3_2 = L3_2(L4_2, L5_2)
      if L3_2 then
        L3_2 = {}
        data = L3_2
        ...
        L3_2.setting_type = L4_2
        L3_2 = data
        L3_2.title_text_id = "UIText_Setting_Event_PrivacyPolicy"
        if L1_2 == false then
          L3_2 = data
          L3_2.setting_title_text_id = "UIText_Setting_Title_Account"
          L1_2 = true
    ...
    if L3_2 then
      ...
      L3_2 = data
      L4_2 = AccountSettingType
      L4_2 = L4_2.ChildPrivacy
      L3_2.setting_type = L4_2
      L3_2 = data
      L3_2.title_text_id = "UIText_Setting_Event_teenagerprivacy"
      if L1_2 == false then
        L3_2 = data
        L3_2.setting_title_text_id = "UIText_Setting_Title_Account"
        L1_2 = true
    ...
    L4_2 = L3_2
    L3_2 = L3_2.OAKPAFBNBAF
    L5_2 = "PersonalInformationInGameUrl"
    L3_2 = L3_2(L4_2, L5_2)
    if L3_2 then
      L3_2 = G
      L3_2 = L3_2.Utils
      ...
      if L3_2 then
        ...
        if not L3_2 then
          ...
          L3_2 = data
          L4_2 = AccountSettingType
          L4_2 = L4_2.PersonalInfo
          L3_2.setting_type = L4_2
          L3_2 = data
          L3_2.title_text_id = "UIText_Setting_Event_personalinformation"
          if L1_2 == false then
            L3_2 = data
            L3_2.setting_title_text_id = "UIText_Setting_Title_Account"
            L1_2 = true
    ...
    if L3_2 then
      ...
      L3_2 = data
      L4_2 = AccountSettingType
      L4_2 = L4_2.ThirdPrivacy
      L3_2.setting_type = L4_2
      L3_2 = data
      L3_2.title_text_id = "UIText_Setting_Event_thirdprivacy"
      if L1_2 == false then
        L3_2 = data
        L3_2.setting_title_text_id = "UIText_Setting_Title_Account"
        L1_2 = true
  ...
  if L3_2 then
    ...
    L3_2 = data
    L4_2 = AccountSettingType
    L4_2 = L4_2.PlayWithPsnOnly
    L3_2.setting_type = L4_2
    L3_2 = data
    L3_2.title_text_id = "UIText_PS_CrossPlaySwitch"
    if L1_2 == false then
      L3_2 = data
      L3_2.setting_title_text_id = "UIText_Setting_Title_Account"
      L1_2 = true
  ...
  if L3_2 then
    ...
    if not L3_2 then
      ...
      L3_2.setting_type = L4_2
      L3_2 = data
      L3_2.title_text_id = "ICP_FilingsCode_19018275"
      if L1_2 == false then
        L3_2 = data
        L3_2.setting_title_text_id = "UIText_Setting_Title_Account"
        L1_2 = true
