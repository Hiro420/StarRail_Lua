...
function L1_1(A0_2, A1_2, A2_2)
  ...
  L4_2 = A1_2
  L3_2[1] = L4_2
  A0_2._monster_waves = L3_2
  L3_2 = A2_2 or L3_2
  if not A2_2 then
    L3_2 = 1
  end
  A0_2._default_index = L3_2
  A0_2._show_wave_index = false
end
L0_1.init = L1_1
function L1_1(A0_2, A1_2, A2_2)
  local L3_2, L4_2, L5_2, L6_2, L7_2, L8_2, L9_2, L10_2, L11_2, L12_2, L13_2, L14_2, L15_2, L16_2
  L3_2 = {}
  A0_2._monster_floor_datas = L3_2
  ...
  for L6_2, L7_2 in L3_2, L4_2, L5_2 do
    ...
    L9_2 = A0_2._monster_floor_datas
    L10_2 = A0_2._monster_floor_datas
    L10_2 = #L10_2
    L10_2 = L10_2 + 1
    L9_2[L10_2] = L8_2
  end
  L3_2 = A0_2._monster_floor_datas
  L3_2 = #L3_2
  A0_2._floor_count = L3_2
  A0_2._default_index = 1
  A0_2._default_floor_idx = 1
  A0_2._is_show_boss_bg = true
end
L0_1.init_by_challenge = L1_1
...
function L1_1(A0_2, A1_2)
  ...
  L2_2 = A0_2._monster_floor_datas
  if L2_2 ~= nil then
    L2_2 = A0_2._monster_floor_datas
    L2_2 = L2_2[A1_2]
    return L2_2
...
L0_1._get_monster_waves_by_floor_index = L1_1
function L1_1(A0_2)
...
function L1_1(A0_2)
  ...
  L1_2 = A0_2._default_floor_idx
  if not L1_2 then
    L1_2 = 1
  end
  L2_2 = A0_2._binder
  L2_2 = L2_2.monster_floor_list
  L3_2 = L2_2
...
function L1_1(A0_2)
  local L1_2, L2_2, L3_2
  L1_2 = A0_2._wave_num_to_buff_list
  if L1_2 == nil then
    L1_2 = A0_2._detail_tabitem
    L2_2 = L1_2
    L1_2 = L1_2.hide_buff_list
    L1_2(L2_2)
    return
  end
  L1_2 = A0_2._wave_num_to_buff_list
  if L1_2 then
    L1_2 = A0_2._wave_num_to_buff_list
    L2_2 = A0_2._cur_wave_index
    L1_2 = L1_2[L2_2]
  end
  A0_2._cur_buff_list = L1_2
  L1_2 = A0_2._last_buff_list
  if L1_2 ~= nil then
    L1_2 = A0_2._last_buff_list
    L2_2 = A0_2._cur_buff_list
    if L1_2 == L2_2 then
      return
    end
  end
  L1_2 = A0_2._detail_tabitem
  L2_2 = L1_2
  L1_2 = L1_2.refresh_buff
  L3_2 = A0_2._cur_buff_list
  L1_2(L2_2, L3_2)
  L1_2 = A0_2._cur_buff_list
  A0_2._last_buff_list = L1_2
end
...
function L1_1(A0_2, A1_2, A2_2)
  ...
  if L4_2 == nil then
    ...
    L7_2 = A0_2._show_wave_index
    L5_2(L6_2, L7_2)
  end
  L5_2 = A2_2 + 1
  L6_2 = A0_2._boss_data_list
  if L6_2 ~= nil then
    L7_2 = L4_2
    L6_2 = L4_2.show_boss_info
    L8_2 = A0_2._boss_data_list
    L8_2 = L8_2[L5_2]
    L6_2(L7_2, L8_2)
  end
  L7_2 = L4_2
  ...
  L9_2 = A0_2
  L8_2 = A0_2._get_monster_waves_by_floor_index
  L10_2 = L5_2
  L8_2 = L8_2(L9_2, L10_2)
  L9_2 = L5_2
  L6_2(L7_2, L8_2, L9_2)
