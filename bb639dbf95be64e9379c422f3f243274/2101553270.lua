...
L0_1.reg_map_function_btn_click_call_back = L2_1
  ...
  if L2_2 then
    ...
    if not L2_2 then
      ...
      if A1_2 == L2_2 then
        ...
        L3_2 = A0_2._owner
        L4_2 = L3_2
        L3_2 = L3_2.setup_message_tip_action_enable
        L5_2 = true
        L3_2(L4_2, L5_2)
      end
    end
...
L0_1._on_item_click_callback = L2_1
function L2_1(A0_2, A1_2, A2_2)
...
L0_1._on_message_item_change = L2_1
return L0_1
