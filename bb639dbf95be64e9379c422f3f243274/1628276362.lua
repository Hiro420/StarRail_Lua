...
L0_1(L1_1)
L0_1 = require
L1_1 = "Ui.Activity.ActivityPanel.GuessTheSilhouetteActivityTabPanelBinder"
L0_1(L1_1)
L0_1 = G
L0_1 = L0_1.Class
L1_1 = "GuessTheSilhouetteActivityTabPanel"
L2_1 = G
L2_1 = L2_1.TabItem
L0_1 = L0_1(L1_1, L2_1)
L1_1 = 4000
...
L2_1 = L2_1.GuessTheSilhouetteActivity
L3_1 = CS
L3_1 = L3_1.RPG
L3_1 = L3_1.Client
...
L4_1 = L4_1.ActivityGuessTheSilhouetteModule
function L5_1(A0_2, A1_2, A2_2, A3_2)
  local L4_2, L5_2, L6_2, L7_2, L8_2
  A0_2._activity_data = A3_2
  L4_2 = {}
  A0_2._config_ids = L4_2
  A0_2._guide_main_mission_id = 0
  A0_2._guide_message_sub_mission_id = 0
  A0_2._guide_message_id = 0
  L4_2 = CS
  L4_2 = L4_2.RPG
  L4_2 = L4_2.GameCore
  L4_2 = L4_2.ActivityConstantGSExcelTable
  L4_2 = L4_2.GetData
  L5_2 = "ActivityFindTrotter_GuessSilhouette_TutorialMission"
  L4_2 = L4_2(L5_2)
  if L4_2 ~= nil then
    L5_2 = CS
    L5_2 = L5_2.System
    ...
    L6_2 = L4_2.Value
    L5_2 = L5_2(L6_2)
    A0_2._guide_main_mission_id = L5_2
  end
  L5_2 = CS
  L5_2 = L5_2.RPG
  L5_2 = L5_2.GameCore
  L5_2 = L5_2.ActivityConstantGSExcelTable
  L5_2 = L5_2.GetData
  L6_2 = "ActivityGuessSilhouette_Quest_Mission_Message"
  L5_2 = L5_2(L6_2)
  if L5_2 ~= nil then
    L6_2 = CS
    L6_2 = L6_2.System
    ...
    L7_2 = L4_2.Value
    L6_2 = L6_2(L7_2)
    A0_2._guide_message_sub_mission_id = L6_2
  end
  L6_2 = CS
  L6_2 = L6_2.RPG
  L6_2 = L6_2.GameCore
  L6_2 = L6_2.ActivityConstantGSExcelTable
  L6_2 = L6_2.GetData
  L7_2 = "ActivityGuessSilhouette_Quest_Message"
  L6_2 = L6_2(L7_2)
  if L6_2 ~= nil then
    L7_2 = CS
    L7_2 = L7_2.System
...
function L5_1(A0_2)
  ...
  A0_2._guide_mission = nil
  A0_2._guide_message_sub_mission = nil
  L2_2 = A0_2
...
function L5_1(A0_2)
  ...
  L3_2 = A0_2._guide_main_mission_id
  L1_2 = L1_2(L2_2, L3_2)
  L2_2 = L1_2
  ...
  function L3_2(A0_3)
    ...
    L1_3 = A0_3
    if L1_3 then
      A0_2._guide_mission = L1_3
    else
      L2_3 = G
      L2_3 = L2_3.SuperDebug
      L2_3 = L2_3.LogErrorFormat
      L3_3 = "GuessTheSilhouetteActivityTabPanel: \230\156\170\232\142\183\229\190\151\231\140\156\231\140\156\230\136\145\230\152\175\232\176\129\229\188\149\229\175\188\228\187\187\229\138\161id: "
      L4_3 = L1_3.ID
      L3_3 = L3_3 .. L4_3
      L2_3(L3_3)
      A0_2._guide_mission = nil
    ...
    L3_3 = L3_3.ActivityForceRefreshRedDot
    L2_3(L3_3)
  end
  L1_2(L2_2, L3_2)
end
L0_1._init_guide_mission = L5_1
function L5_1(A0_2)
  local L1_2, L2_2, L3_2
  L1_2 = A0_2._binder
...
function L5_1(A0_2)
  ...
  L2_2 = "UIText_QuestOverviewtDialog_Intro"
  L3_2 = A0_2._activity_data
  L3_2 = L3_2.IntroDesc
  L1_2(L2_2, L3_2)
end
...
function L5_1(A0_2)
  ...
  if L1_2 then
    ...
    L2_2 = "Ui.Activity.ActivityGuessTheSilhouette.ActivityGuessTheSilhouetteMainPage"
    L1_2(L2_2)
  else
    L2_2 = A0_2
    L1_2 = A0_2._on_procees_guide_mission
    L1_2(L2_2)
  end
  L1_2 = CS
  L1_2 = L1_2.RPG
  ...
  L1_2 = L1_2.Prefs
  L1_2 = L1_2.User
  L1_2 = L1_2.ActivityGotoClickedTypes
  L2_2 = L1_2
  L1_2 = L1_2.Contains
  L3_2 = L2_1
  L1_2 = L1_2(L2_2, L3_2)
...
function L5_1(A0_2)
  ...
  if L1_2 <= 0 then
    ...
    L2_2 = "GuessTheSilhouetteActivityTabPanel: \229\189\147\229\137\141\228\187\187\229\138\161id: "
    L3_2 = A0_2._guide_mission
    L3_2 = L3_2.ID
    L4_2 = "\229\188\130\229\184\184\239\188\140\230\140\129\230\156\137\229\173\144\228\187\187\229\138\161\230\149\176\233\135\143\228\184\1860"
    L2_2 = L2_2 .. L3_2 .. L4_2
    L1_2(L2_2)
    return
  end
  ...
  L4_2 = L4_2.None
  L4_2 = #L4_2
  L5_2 = A0_2._guide_mission
  L5_2 = L5_2.ID
  L3_2[1] = L4_2
  L3_2[2] = L5_2
  L1_2(L2_2, L3_2)
end
L0_1._on_procees_guide_mission = L5_1
function L5_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2
  L1_2 = G
  L1_2 = L1_2.GotoManager
  ...
  L2_2 = L1_1
  L3_2 = {}
  L4_2 = A0_2._guide_message_id
  L3_2[1] = L4_2
  L1_2(L2_2, L3_2)
end
L0_1._open_event_message = L5_1
function L5_1(A0_2)
  local L1_2, L2_2, L3_2
  L1_2 = CS
  L1_2 = L1_2.RPG
