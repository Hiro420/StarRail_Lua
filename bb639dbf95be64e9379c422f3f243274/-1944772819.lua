...
function L6_1(A0_2)
  ...
  if L1_2 then
    ...
    if L1_2 then
      ...
      L3_2 = A0_2
      L2_2 = A0_2._on_mission_btn_transfer_click
      L2_2(L3_2)
    end
  else
    L1_2 = G
...
function L6_1(A0_2)
  ...
  function L5_2(A0_3)
    ...
    if A0_3 then
      L1_3 = G
      L1_3 = L1_3.MapUtil
      L1_3 = L1_3.try_get_nearest_teleport_id
      L2_3 = A0_2._target_layer
      L3_3 = A0_2._target_position
      L4_3 = A0_2._cur_map_layer_count
      L5_3 = A0_2._map_container_panel
      L1_3 = L1_3(L2_3, L3_3, L4_3, L5_3)
      L2_3 = A0_2
      L3_3 = L2_3
      L2_3 = L2_3.get_blackboard
      L2_3 = L2_3(L3_3)
      L3_3 = L2_3
      L2_3 = L2_3.query
      L4_3 = "StoryLineID"
      ...
      L4_3 = L3_3
      L3_3 = L3_3.Transfer
      L5_3 = A0_2.entrance_id
      L6_3 = L1_3
      L7_3 = L2_3
      L8_3 = A0_2._dimension_id
...
function L6_1(A0_2)
  ...
  function L4_2(A0_3)
    ...
    if A0_3 then
      L1_3 = A0_2
      L2_3 = L1_3
      L1_3 = L1_3._get_nearest_teleport_id_by_sub_map
      L1_3 = L1_3(L2_3)
      L2_3 = A0_2
      L3_3 = L2_3
      L2_3 = L2_3.get_blackboard
...
L0_1._transfer_nearest_teleport_by_sub_map = L6_1
function L6_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2, L5_2
...
L0_1._get_nearest_teleport_id_by_sub_map = L6_1
return
