...
L0_1(L1_1)
L0_1 = require
L1_1 = "Ui.Activity.ActivityPanel.AbyssYukongActivityPanelBinder"
L0_1(L1_1)
L0_1 = require
...
L2_1 = L2_1.GetData
L3_1 = "ChallengeMaze_Yukong_PreMainMissionIDList"
L2_1 = L2_1(L3_1)
L2_1 = L2_1.Value
L2_1 = L2_1.ArrayValue
L3_1 = G
L3_1 = L3_1.Class
L4_1 = "AbyssYukongActivityPanel"
L5_1 = G
L5_1 = L5_1.TabItem
L3_1 = L3_1(L4_1, L5_1)
...
function L4_1(A0_2)
  ...
  for L4_2 = L1_2, L2_2, L3_2 do
    ...
    L6_2 = table
    L6_2 = L6_2.insert
    L7_2 = A0_2._unlock_mission_list
    L8_2 = L5_2
    L6_2(L7_2, L8_2)
  end
end
      ...
      if L5_3 ~= nil then
        ...
        if not L6_3 then
          ...
          if L6_3 then
            ...
            L6_3 = L6_3.GetText
            L7_3 = "ChallengeMazeWorldCondition_Mission"
            L8_3 = L5_3.NameStr
            L6_3 = L6_3(L7_3, L8_3)
            L7_3 = G
