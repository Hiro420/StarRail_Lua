...
L0_1 = require
L1_1 = "Ui.BoxingClub.Components.BoxingClubResonanceEnemyPanelBinder"
L0_1(L1_1)
L0_1 = G
L0_1 = L0_1.Class
L1_1 = "BoxingClubResonanceEnemyPanel"
L2_1 = G
L2_1 = L2_1.BasePanel
L0_1 = L0_1(L1_1, L2_1)
L1_1 = {}
...
L2_1 = L2_1.RPG
L2_1 = L2_1.Client
L2_1 = L2_1.BoxingClubResonanceUIStageEnum
L2_1 = L2_1.SelectResonanceBuff
L2_1 = #L2_1
L1_1.SelectResonanceBuff = L2_1
L2_1 = CS
L2_1 = L2_1.RPG
L2_1 = L2_1.Client
L2_1 = L2_1.BoxingClubResonanceUIStageEnum
L2_1 = L2_1.EditTeamMode
L2_1 = #L2_1
L1_1.EditTeamMode = L2_1
L2_1 = CS
L2_1 = L2_1.RPG
L2_1 = L2_1.Client
L2_1 = L2_1.BoxingClubResonanceUIStageEnum
L2_1 = L2_1.SelectOptionalBuff
L2_1 = #L2_1
L1_1.SelectOptionalBuff = L2_1
L2_1 = CS
L2_1 = L2_1.RPG
L2_1 = L2_1.Client
L2_1 = L2_1.BoxingClubResonanceUIStageEnum
L2_1 = L2_1.WaitingBattle
L2_1 = #L2_1
L1_1.WaitingBattle = L2_1
L2_1 = CS
L2_1 = L2_1.RPG
L2_1 = L2_1.Client
...
L3_1 = "UIText_BoxingClub_Challenge_StageNullName"
L4_1 = "UIText_BoxingClub_Challenge_GoBattle"
L5_1 = CS
L5_1 = L5_1.RPG
L5_1 = L5_1.GameCore
L5_1 = L5_1.BoxingClubStageConfigExcelTable
L6_1 = 1.5
function L7_1(A0_2)
...
function L7_1(A0_2, A1_2, A2_2, A3_2)
  ...
  L4_2 = L4_2(L5_2)
  A0_2._boxing_club_stage_row = L4_2
  L4_2 = G
  L4_2 = L4_2.new
  L5_2 = G
  ...
  L4_2(L5_2)
  L5_2 = A0_2
  L4_2 = A0_2.update_node_by_stage
  L4_2(L5_2)
  L5_2 = A0_2
  ...
  L4_2(L5_2)
  L4_2 = A0_2._binder
  L4_2 = L4_2.enemy_list_panel
  L5_2 = L4_2
  L4_2 = L4_2.setup_view
  L7_2 = A0_2
  L6_2 = A0_2._generate_cur_stage_monster_datas
  L6_2, L7_2 = L6_2(L7_2)
  L4_2(L5_2, L6_2, L7_2)
end
...
function L7_1(A0_2)
  local L1_2, L2_2
  L1_2 = A0_2._binder
  L1_2 = L1_2.enemy_list_panel
  L2_2 = L1_2
  L1_2 = L1_2.force_rebuild_layout
  L1_2(L2_2)
end
L0_1.force_rebuild_layout = L7_1
function L7_1(A0_2, A1_2)
  A0_2._challenge_id = A1_2
end
L0_1.setup_challenge_id = L7_1
function L7_1(A0_2, A1_2)
...
L0_1.switch_view_when_effect = L7_1
function L7_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2, L5_2
  L1_2 = A0_2._cur_stage
  L2_2 = L1_1.SelectResonanceBuff
  if L1_2 <= L2_2 then
    return
  end
...
L0_1._update_stage_info_by_event_id = L7_1
function L7_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2, L5_2
  L1_2 = A0_2._cur_stage
  L2_2 = L1_1.SelectResonanceBuff
...
L0_1.update_node_by_stage = L7_1
function L7_1(A0_2)
  ...
  if L1_2 <= L2_2 then
    ...
    L2_2 = L1_2
    L1_2 = L1_2.SafeSetTextID
    L3_2 = A0_2._boxing_club_stage_row
    L3_2 = L3_2.Name
    L1_2(L2_2, L3_2)
  end
end
L0_1._update_enemy_name = L7_1
function L7_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2, L5_2
  L1_2 = A0_2._cur_stage
  L2_2 = L1_1.SelectResonanceBuff
...
L0_1._update_img_by_stage = L7_1
function L7_1(A0_2)
  local L1_2, L2_2, L3_2
  L1_2 = A0_2._binder
  L1_2 = L1_2.btn_desc
...
L0_1._update_button_desc_by_stage = L7_1
function L7_1(A0_2)
  local L1_2, L2_2, L3_2
  L1_2 = A0_2._cur_stage
  L2_2 = L1_1.SelectResonanceBuff
...
L0_1._update_enemy_talk = L7_1
function L7_1(A0_2)
  local L1_2, L2_2, L3_2
  L1_2 = A0_2._binder
  L1_2 = L1_2.text_monster_wave
  L2_2 = L1_2
...
L0_1._generate_cur_stage_monster_datas = L7_1
function L7_1(A0_2)
  local L1_2, L2_2
  L1_2 = A0_2._owner
...
function L7_1(A0_2)
  ...
  L1_2 = A0_2._owner
  L2_2 = L1_2
  L1_2 = L1_2.play_start_battle_anim
  L1_2(L2_2)
  L1_2 = L2_1
  L2_2 = L1_2
  ...
  L3_2 = L3_2.CIBCOECMKEO
  L1_2(L2_2, L3_2)
end
L0_1._on_start_battle_btn_clicked = L7_1
return L0_1
