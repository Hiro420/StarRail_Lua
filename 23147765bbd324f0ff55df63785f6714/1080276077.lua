...
function L2_1()
  local L0_2, L1_2
  L0_2 = "UI/Common/Widget/MainStoryMissionHint.prefab"
  return L0_2
end
L0_1.get_prefab_path = L2_1
function L2_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2
  A0_2.start_text = "UIText_AdventureMissionStatusHint_New"
  A0_2.finish_text = "UIText_AdventureMissionStatusHint_Complete"
  L2_2 = A0_2
