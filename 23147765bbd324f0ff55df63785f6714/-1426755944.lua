...
L0_1 = require
L1_1 = "Ui.Talk.TalkDebate.DebateSuccessHintDialogBinder"
L0_1(L1_1)
L0_1 = "DebuteSuccessHintDialog_FadeIn"
L1_1 = "DebuteSuccessHintDialog_Fadeout"
L2_1 = G
L2_1 = L2_1.Class
L3_1 = "DebateSuccessHintDialog"
L4_1 = G
...
function L3_1(A0_2)
  ...
  L3_2 = G
  L3_2 = L3_2.DebateSuccessHintDialogBinder
  L1_2 = L1_2(L2_2, L3_2)
  A0_2._binder = L1_2
end
L2_1.ctor = L3_1
...
function L3_1(A0_2)
  ...
  if L2_2 ~= nil then
    ...
    if L3_2 == L4_2 then
      ...
      L5_2 = "UIText_Debute_SuccessToast1"
      L3_2(L4_2, L5_2)
    else
      L3_2 = L2_2.UIType
      L4_2 = CS
      ...
      if L3_2 == L4_2 then
        ...
        L4_2 = L3_2
        L3_2 = L3_2.SafeSetTextID
        L5_2 = "UIText_Debute_SuccessToast2"
        L3_2(L4_2, L5_2)
      end
    end
  end
