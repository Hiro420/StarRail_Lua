...
L0_1 = require
L1_1 = "Ui.Avatar.AvatarSelect.AvatarSelectMembersTabItemBinder"
L0_1(L1_1)
L0_1 = require
...
L0_1 = G
L0_1 = L0_1.Class
L1_1 = "AvatarSelectMembersTabItem"
L2_1 = G
L2_1 = L2_1.TabItem
L0_1 = L0_1(L1_1, L2_1)
function L1_1(A0_2)
...
L0_1.set_custom_get_avatar_item_callback = L1_1
function L1_1(A0_2, A1_2, A2_2)
...
function L1_1(A0_2)
  local L1_2, L2_2
  L2_2 = A0_2
  L1_2 = A0_2.refresh_displayed_avatars
  L1_2(L2_2)
end
L0_1.refresh = L1_1
function L1_1(A0_2)
...
function L1_1(A0_2, A1_2, A2_2)
  ...
  if L4_2 == nil then
    ...
    L8_2 = A0_2._click_callback_self
    L5_2(L6_2, L7_2, L8_2)
  end
  ...
  L7_2 = A0_2._setup_callback
  L8_2 = A0_2._setup_callback_self
  L9_2 = L4_2
  L10_2 = L5_2
