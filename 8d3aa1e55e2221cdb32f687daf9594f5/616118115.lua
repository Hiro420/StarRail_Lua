...
function L5_1(A0_2)
  ...
  L1_2 = {}
  A0_2.waypoint_config_list = L1_2
  L1_2 = {}
  A0_2.waypoint_config_dic = L1_2
  L1_2 = {}
...
function L5_1(A0_2)
  local L1_2
  L1_2 = A0_2.waypoint_config_list
  return L1_2
end
L0_1.get_waypoint_config_table = L5_1
function L5_1(A0_2, A1_2)
  local L2_2
  L2_2 = A0_2.waypoint_config_dic
  L2_2 = L2_2[A1_2]
  return L2_2
end
...
function L5_1(A0_2, A1_2)
  ...
  L4_2(L5_2)
  L4_2 = {}
  A0_2.waypoint_config_dic = L4_2
  L4_2 = 1
  L5_2 = A0_2.waypoint_config_list
  L5_2 = #L5_2
  L6_2 = 1
  for L7_2 = L4_2, L5_2, L6_2 do
    L8_2 = A0_2.waypoint_config_list
    L8_2 = L8_2[L7_2]
    L8_2 = L8_2.Target
    if L8_2 then
      L8_2 = A0_2.waypoint_config_list
      ...
      if L8_2 then
        ...
        L8_2 = L8_2.IsHide
        if not L8_2 then
          L8_2 = A0_2.waypoint_config_dic
          L9_2 = A0_2.waypoint_config_list
          L9_2 = L9_2[L7_2]
          L9_2 = L9_2.Target
          ...
          L9_2 = L9_2.insert
          L10_2 = L8_2
          L11_2 = A0_2.waypoint_config_list
          L11_2 = L11_2[L7_2]
          L9_2(L10_2, L11_2)
        end
      end
...
function L5_1(A0_2, A1_2, A2_2)
  ...
  if L4_2 ~= nil then
    ...
    for L7_2 = L4_2, L5_2, L6_2 do
      ...
      L11_2 = CS
      L11_2 = L11_2.EJCNCBDFBKA
      L11_2 = L11_2.HNFAHNKMIAJ
      L10_2 = L10_2(L11_2)
      if L9_2 == L10_2 then
        L10_2 = L8_2
...
function L5_1(A0_2, A1_2)
  ...
  if L4_2 then
    ...
    if L2_2 ~= nil then
      ...
      L8_2.IsGameObject = false
      L10_2 = L4_2.MapPosition
      L8_2.TargetPos = L10_2
    end
    L11_2 = A0_2
...
function L5_1(A0_2, A1_2, A2_2, A3_2, A4_2)
  ...
  L8_2 = L8_2.Client
  L8_2 = L8_2.TimeUtils
  L8_2 = L8_2.ClientNowMsTimeStamp
  A1_2.CreateTime = L8_2
  return A1_2
end
...
function L5_1(A0_2, A1_2)
  ...
  A1_2.IsHide = false
  L2_2 = ipairs
  L3_2 = A0_2.waypoint_config_list
  L2_2, L3_2, L4_2 = L2_2(L3_2)
  for L5_2, L6_2 in L2_2, L3_2, L4_2 do
    L8_2 = A0_2
    L7_2 = A0_2._should_hide
    L9_2 = A1_2
    L10_2 = L6_2
    L7_2 = L7_2(L8_2, L9_2, L10_2)
    if L7_2 then
...
function L5_1(A0_2, A1_2, A2_2)
  ...
  L3_2 = A1_2.WaypointType
  L4_2 = L3_1.MissionAssist
  if L3_2 == L4_2 then
    L3_2 = A2_2.WaypointType
    L4_2 = L3_1.MissionAssist
    if L3_2 ~= L4_2 then
      A1_2.IsHide = true
      L3_2 = true
